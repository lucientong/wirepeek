...
std::vector<uint8_t> MakeTcpHeader(uint16_t src_port, uint16_t dst_port, uint8_t flags,
  ...
  std::vector<uint8_t> seg = {
      static_cast<uint8_t>(src_port >> 8), static_cast<uint8_t>(src_port & 0xFF),  // Src port
      static_cast<uint8_t>(dst_port >> 8), static_cast<uint8_t>(dst_port & 0xFF),  // Dst port
...
std::vector<uint8_t> MakeTcpHeaderWithOptions(uint16_t src_port, uint16_t dst_port,
                                               uint8_t flags) {
